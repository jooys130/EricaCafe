					...
					<section class="post">
						...
						<?php
							if(isset($_SESSION['user_id'])){
								...
								for($i = 0; $i<count($result); $i++){
									if($result[$i]["id"] == $_SESSION['user_id'] and $result[$i]["cafe"] == "cafe_4"){
										$flag = 1;
										echo "<form action=\"../delFav.php\" method=\"post\">
													<button type='submit' name='del' id='del' value='cafe_4'>Delete Bookmark</button>
											  </form>";
									break;
									}
								}
								if($flag != 1){
									echo "<form action=\"../addFav.php\" method=\"post\">
												<button type='submit' name='add' id='add' value='cafe_4'>Add Bookmark</button>
										  </form>";
								}
							}
						?>	
						...
						<div class="basic_info">
							...
							<img src="icon/location.png" width="30px" height="30px"><strong>Location</strong>
						  	<p>경기 안산시 상록구 학사2길 2 1층 (우)15587</p>
							<p>지번 : 사동 1154</p>
							<div></div>
						  	...
						  	<p><a href="https://www.amasvin.com" title="amasvin">www.amasvin.com</a></p>
						  	<div></div>
						...
						<div class="menu_info">
						  	...
						  	<ul>
						  		<li>
						  			<strong>아메리카노
						  			・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・ 
						  			<div class="price">1,800</div></strong>
						  		</li>
						  		<li>
						  			<strong>카페라떼
						  			・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・ 
						  		...
						  		<li>
						  			<strong>연유라떼
						  			・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・ 
						  			<div class="price">3,700</div></strong>
						  		</li>
						  	</ul>

						  	<div style="margin-left: 20px;">
						  		<a href="image/4.png"><strong>Detail menu ▶</strong></a>	
						  	</div>
