					...
					<section class="post">
						...
						<?php
							if(isset($_SESSION['user_id'])){
								...
								for($i = 0; $i<count($result); $i++){
									if($result[$i]["id"] == $_SESSION['user_id'] and $result[$i]["cafe"] == "cafe_17"){
										$flag = 1;
										echo "<form action=\"../delFav.php\" method=\"post\">
													<button type='submit' name='del' id='del' value='cafe_17'>Delete Bookmark</button>
											  </form>";
									break;
									}
								}
								if($flag != 1){
									echo "<form action=\"../addFav.php\" method=\"post\">
												<button type='submit' name='add' id='add' value='cafe_17'>Add Bookmark</button>
										  </form>";
								}
							}
						?>	
						...
						<div class="basic_info">
							...
							<img src="icon/location.png" width="30px" height="30px"><strong>Location</strong>
						  	<p>경기 안산시 상록구 한양대학로 16 1,2층 (우)15578</p>
							<p>지번 : 사동 1581-4</p>
							<div></div>
						  	...
						  	<p><a href="https://www.instagram.com/cafe_crevasse/" title="cafe_crevasse">www.instagram.com/cafe_crevasse</a></p>
						  	<div></div>
						...
						<div class="menu_info">
							...
							<div style="margin-left: 20px;">
						  		<a href="image/17.png"><strong>Detail menu ▶</strong></a>	
						  	</div>
