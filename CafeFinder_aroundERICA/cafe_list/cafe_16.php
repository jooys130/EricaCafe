					...
					<section class="post">
						...
						<?php
							if(isset($_SESSION['user_id'])){
								...
								for($i = 0; $i<count($result); $i++){
									if($result[$i]["id"] == $_SESSION['user_id'] and $result[$i]["cafe"] == "cafe_16"){
										$flag = 1;
										echo "<form action=\"../delFav.php\" method=\"post\">
													<button type='submit' name='del' id='del' value='cafe_16'>Delete Bookmark</button>
											  </form>";
									break;
									}
								}
								if($flag != 1){
									echo "<form action=\"../addFav.php\" method=\"post\">
												<button type='submit' name='add' id='add' value='cafe_16'>Add Bookmark</button>
										  </form>";
								}
							}
						?>	
						...
						<div class="basic_info">
							...
							<img src="icon/location.png" width="30px" height="30px"><strong>Location</strong>
						  	<p>경기 안산시 상록구 성안1길 38 1층 (우)15578</p>
							<p>지번 : 사동 1572-4</p>
							<div></div>

						  	<img src="icon/clock.png" width="30px" height="30px"><strong>Business hours</strong>
						  	<p>수 목 토 일 12:00 ~ 19:00</p>
						  	<p>월 화 금 휴무일</p>
						  	<div></div>

						  	<img src="icon/website.png" width="30px" height="30px"><strong>Website</strong>
						  	<p><a href="https://www.instagram.com/cafe_introvert/" title="cafe_introvert">www.instagram.com/cafe_introvert</a></p>
						  	<div></div>
