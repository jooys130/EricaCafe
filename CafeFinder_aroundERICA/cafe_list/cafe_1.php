...
<html>
	<head>
		<title>워터킹커피로스터스 | EricaCafe</title>
		<meta charset="utf-8" />
					...
					<section class="post">
						...
						<?php
							if(isset($_SESSION['user_id'])){
								...
								for($i = 0; $i<count($result); $i++){
									if($result[$i]["id"] == $_SESSION['user_id'] and $result[$i]["cafe"] == "cafe_1"){
										$flag = 1;
										echo "<form action=\"../delFav.php\" method=\"post\">
													<button type='submit' name='del' id='del' value='cafe_1'>Delete Bookmark</button>
											  </form>";
									break;
									}
								}
								if($flag != 1){
									echo "<form action=\"../addFav.php\" method=\"post\">
												<button type='submit' name='add' id='add' value='cafe_1'>Add Bookmark</button>
										  </form>";
								}
							}
						?>	
						...
						<div class="menu_info">
						  	...
						  	<div style="margin-left: 20px;">
						  		<a href="image/1.png"><strong>Detail menu ▶</strong></a>	
						  	</div>
