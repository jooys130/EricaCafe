					...
					<section class="post">
						...
						<?php
							if(isset($_SESSION['user_id'])){
								...
								for($i = 0; $i<count($result); $i++){
									if($result[$i]["id"] == $_SESSION['user_id'] and $result[$i]["cafe"] == "cafe_8"){
										$flag = 1;
										echo "<form action=\"../delFav.php\" method=\"post\">
													<button type='submit' name='del' id='del' value='cafe_8'>Delete Bookmark</button>
											  </form>";
									break;
									}
								}
								if($flag != 1){
									echo "<form action=\"../addFav.php\" method=\"post\">
												<button type='submit' name='add' id='add' value='cafe_8'>Add Bookmark</button>
										  </form>";
								}
							}
						?>	
						...
						<div class="basic_info">
							...
							<img src="icon/location.png" width="30px" height="30px"><strong>Location</strong>
						  	<p>경기 안산시 상록구 한양대학로 45 3층 (우)15587</p>
							<p>지번 : 사동 1149-6</p>
							<div></div>
						  	...
						  	<p><a href="https://www.yogerpresso.co.kr/" title="yogerpresso">www.yogerpresso.co.kr</a></p>
						  	<div></div>
